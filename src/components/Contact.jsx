...
export const Contact = () => {
  ...
  const whatsappLink = `https://wa.me/5511930000000?text=Olá! Gostaria de mais informações sobre os serviços da JT Engenharia.`;
            ...
            <div className="info-section">
              ...
              <div className="info-item">
                ...
                <div className="info-details">
                  ...
                  <p className="info-value">contato@jtengenharia.com</p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="info-details">
                  ...
                  <p className="info-value">(62) 3000-0000</p>
                </div>
              </div>
